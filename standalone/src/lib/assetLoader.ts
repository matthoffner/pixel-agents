...
export async function loadFurnitureAssets(
  ...
  try {
    ...
    if (!fs.existsSync(catalogPath)) {
      console.log('No furniture catalog found at:', catalogPath)
      return null
    }
...
/**
 * Send wall tiles to all connected clients
 */
export function sendWallTiles(
  ...
  console.log(`Sent ${wallTiles.sprites.length} wall tile pieces to clients`)
}
...
/**
 * Send floor tiles to all connected clients
 */
export function sendFloorTiles(
  ...
  console.log(`Sent ${floorTiles.sprites.length} floor tile patterns to clients`)
}
...
/**
 * Send character sprites to all connected clients
 */
export function sendCharacterSprites(
  ...
  console.log(`Sent ${charSprites.characters.length} character sprites to clients`)
}

/**
 * Send loaded assets to all connected clients
 */
export function sendAssets(
  assets: LoadedAssets,
): void {
  if (!assets) {
    console.log('[AssetLoader] No assets to send')
    return
  }
  ...
  console.log(`Sent ${assets.catalog.length} furniture assets to clients`)
}
