...
// ── TV Panel ────────────────────────────────────────────────
export const TV_PANEL_BG = '#0a0e18'
export const TV_TEXT_COLOR = '#33ff66'
export const TV_HEADER_COLOR = '#66ffaa'
export const TV_DIM_COLOR = '#1a9944'
export const TV_ROW_HOVER_BG = 'rgba(51, 255, 102, 0.06)'
export const TV_ROW_BORDER = 'rgba(51, 255, 102, 0.08)'
export const TV_STAGE_BORDER = 'rgba(51, 255, 102, 0.15)'
export const TV_ERROR_COLOR = '#ff4444'
export const TV_STATUS_COLORS = {
  success: '#33ff66',
  passed: '#33ff66',
  failed: '#ff4444',
  running: '#ffcc33',
